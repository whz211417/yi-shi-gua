...
const taxonomy = {
  中国菜: {
    ...
    苏菜: {
      热菜: ['清炖狮子头', '松鼠鳜鱼', '大煮干丝', '软兜长鱼', '三套鸭', '无锡排骨', '糖醋桂鱼', '碧螺虾仁', '梁溪脆鳝', '清炒虾仁', '樱桃肉', '镜箱豆腐'],
      凉菜卤味: ['盐水鸭', '水晶肴肉', '苏式熏鱼', '香糟鹅', '卤汁豆干', '无锡酱鸭', '南京雨花茶干', '镇江香醋萝卜皮'],
      汤羹: ['文思豆腐', '鲃肺汤', '霸王别姬', '鸡汤煮干丝', '鸭血粉丝汤', '砂锅鱼头'],
    ...
    徽菜: {
      ...
      汤羹: ['火腿炖甲鱼', '中和汤', '徽州丸子汤', '石耳炖鸡', '笋干老鸭煲', '黄山野菜汤'],
      面点主食: ['黄山烧饼', '绩溪挞粿', '深渡包袱', '石头粿', '三河米饺', '徽州裹粽', '徽州炒饭', '合肥鸭油烧饼', '泾县锅贴', '阜阳格拉条', '太和板面'],
