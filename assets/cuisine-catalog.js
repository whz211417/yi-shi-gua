...
const taxonomy = {
  中国菜: {
    ...
    西北菜: { 热菜: ['大盘鸡', '手抓羊肉', '黄焖羊肉', '孜然羊肉', '葱爆羊肉', '烤全羊', '陕北烩菜'], 凉菜: ['凉拌面筋', '凉拌沙葱', '炝拌土豆丝', '陕北拼盘'], 面食: ['兰州牛肉面', '油泼面', '岐山臊子面', '裤带面', '揪面片', '羊肉臊子面'], 小吃: ['肉夹馍', '羊肉泡馍', '陕西凉皮', '柿子饼', '甑糕'] },
    云南菜: { 热菜: ['汽锅鸡', '小炒黄牛肉', '黑三剁', '宣威火腿炒饵块', '傣味柠檬鸡', '水性杨花炒蛋', '石屏豆腐', '青椒松茸'], 凉菜: ['凉拌米线', '鬼鸡', '傣味舂鸡脚', '凉拌树花'], 汤锅: ['野生菌火锅', '宜良烤鸭蘸水', '酸笋煮鱼', '土锅鸡'], 米线: ['过桥米线', '小锅米线', '豆花米线', '鳝鱼米线'], 小吃: ['鲜花饼', '破酥包', '宣威火腿月饼', '烤乳扇'] },
