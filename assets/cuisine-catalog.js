...
const taxonomy = {
  ...
  南亚料理: {
    印度菜: { 咖喱: ['黄油鸡咖喱', '蔬菜咖喱', '咖喱羊肉', '南印度鱼咖喱', '鹰嘴豆咖喱'], 主食: ['印度飞饼', '抓饭', '黄油烤饼', '坦都里烤饼', '香料饭'], 坦都里烧烤: ['坦都里鸡', '烤羊肉串', '烤鸡腿', '烤虾', '帕尼尔烤串'], 小吃甜品: ['萨莫萨', '帕可拉炸蔬菜', '玛萨拉多萨', '奶豆腐球', '拉西酸奶'] },
  },
  欧洲料理: {
    意餐: { 面食: ['意大利面', '千层面', '肉酱意面', '奶油培根意面', '海鲜意面'], 披萨: ['玛格丽特披萨', '肉酱披萨', '意式火腿披萨', '四种奶酪披萨', '海鲜披萨'], 烩饭主菜: ['蘑菇烩饭', '海鲜烩饭', '意式烤鸡', '米兰炸肉排', '佛卡夏'], 甜品小食: ['提拉米苏', '卡布里沙拉', '意式炸饭团', '意式蔬菜汤', '潘娜托尼'] },
    法餐: { 主菜: ['油封鸭', '勃艮第牛肉', '法式煎鹅肝', '普罗旺斯炖菜', '诺曼底苹果炖鸡'], 汤羹: ['法式洋葱汤', '龙虾浓汤', '奶油蘑菇汤', '法式海鲜汤', '韭葱土豆汤'], 面包小食: ['法棍三明治', '法式咸派', '焗蜗牛', '尼斯沙拉', '火腿奶酪可颂'], 甜品: ['可丽露', '焦糖布丁', '歌剧院蛋糕', '马卡龙', '法式苹果塔'] },
    西式简餐: { 主食: ['焗饭', '意式烩饭', '奶油蘑菇焗饭', '鸡肉焗饭', '海鲜焗饭'], 主菜: ['烤鸡', '牛排', '香煎三文鱼', '香草烤羊排', '黑椒猪扒'], 沙拉: ['凯撒沙拉', '金枪鱼沙拉', '烤南瓜沙拉', '鸡胸肉沙拉', '土豆沙拉'], 汤小食: ['奶油南瓜汤', '玉米浓汤', '蒜香面包', '炸洋葱圈', '芝士薯角'] },
  },
  美洲料理: {
    墨西哥菜: { 卷饼: ['塔可', '墨西哥卷饼', '墨西哥鸡肉卷', '牛肉法吉塔', '芝士玉米饼'], 热菜: ['辣味炖豆', '墨西哥辣肉酱', '烤玉米', '墨西哥烤鸡', '海鲜酸橘汁腌鱼'], 主食: ['墨西哥炒饭', '玉米饼饭', '辣酱牛肉饭', '豆泥饭', '牛油果饭'], 小吃: ['玉米片', '鳄梨酱', '芝士玉米片', '墨西哥炸玉米卷', '焦糖吉拿棒'] },
    美式餐: { 汉堡: ['牛肉汉堡', '鸡肉汉堡', '培根芝士汉堡', '双层牛肉汉堡', '炸鸡汉堡'], 烧烤: ['美式烤肋排', '烟熏牛胸肉', '烤鸡翅', '美式烤猪肩', '烤玉米'], 早午餐: ['松饼', '班尼迪克蛋', '美式煎蛋卷', '华夫饼', '早餐培根'], 小食甜品: ['水牛城辣鸡翅', '芝士通心粉', '美式热狗', '苹果派', '纽约芝士蛋糕'] },
  },
  '中东 / 地中海': {
