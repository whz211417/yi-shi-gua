...
const taxonomy = {
  ...
  '中东 / 地中海': {
    土耳其: {
      烤肉: ['阿达纳烤肉串', '乌尔法烤肉串', '伊斯肯德尔烤肉', '土耳其旋转烤肉', '土耳其烤肉卷'],
      汤羹: ['埃佐盖林扁豆汤', '土耳其酸奶汤', '伊什肯贝汤', '土耳其婚礼汤'],
      主食小食: ['皮德饼', '拉赫马君', '土耳其芝士卷', '土耳其生肉丸', '苏朱克香肠', '土耳其烤栗子'],
      甜品: ['巴克拉瓦', '库内费', '土耳其软糖', '土耳其米布丁', '阿舒拉甜粥'],
    },
    中东风味: {
      烤肉: ['沙威玛', '科夫塔烤肉', '什什陶克鸡肉串', '阿拉伯烤羊肉串', '也门曼迪烤鸡'],
      蘸酱冷盘: ['鹰嘴豆泥', '巴巴甘努吉', '塔布勒沙拉', '法图什沙拉', '酿葡萄叶'],
      饭饼主食: ['库斯库斯', '马克卢巴', '卡布萨饭', '穆萨坎鸡肉饼', '马纳基什薄饼'],
      汤炖菜: ['摩洛哥塔吉锅', '法索利亚炖豆', '小扁豆汤', '哈里拉汤'],
      小食甜品: ['法拉费', '基贝炸肉饼', '巴斯布萨', '乌姆阿里面包布丁'],
    },
    地中海料理: {
      沙拉凉菜: ['希腊沙拉', '法图什沙拉', '塔布勒沙拉', '酿葡萄叶', '橄榄油烩朝鲜蓟'],
      海鲜鱼类: ['烤章鱼', '瓦伦西亚海鲜饭', '蒜香橄榄油虾', '普罗旺斯鱼汤', '西西里烤剑鱼'],
      主菜烩菜: ['普罗旺斯炖菜', '希腊穆萨卡', '西班牙土豆蛋饼', '柠檬香草烤鸡', '烤哈卢米奶酪'],
      主食小食: ['皮塔饼', '希腊皮塔卷', '橄榄佛卡夏', '西西里阿兰奇炸饭团', '塞浦路斯哈卢米皮塔'],
      甜品: ['希腊酸奶蜂蜜核桃', '意式柠檬奶冻', '西班牙焦糖布丁', '马略卡恩萨伊马达'],
    },
  },
  跨地域: {
    轻食沙拉: {
      沙拉: ['鸡胸肉凯撒沙拉', '尼斯金枪鱼沙拉', '考伯沙拉', '沃尔多夫沙拉', '地中海藜麦沙拉'],
      谷物碗: ['藜麦鸡肉能量碗', '三文鱼糙米碗', '烤蔬菜鹰嘴豆碗', '羽衣甘蓝藜麦碗', '豆腐荞麦面碗'],
      早餐轻食: ['隔夜燕麦', '希腊酸奶水果燕麦杯', '奇亚籽布丁', '巴西莓果碗', '全麦牛油果吐司'],
      轻食小食: ['鸡肉牛油果全麦卷', '鱼柳藜麦卷', '鹰嘴豆泥蔬菜拼盘', '毛豆藜麦饼', '低脂金枪鱼全麦贝果'],
    },
    三明治汉堡: {
      三明治: ['火腿芝士三明治', 'BLT三明治', '鲁本三明治', '古巴三明治', '费城牛肉芝士三明治'],
      汉堡: ['经典芝士汉堡', '培根芝士汉堡', '蘑菇瑞士汉堡', '俄克拉何马洋葱汉堡', '黑豆素食汉堡'],
      热狗卷饼: ['纽约热狗', '芝加哥热狗', '墨西哥鸡肉法希塔卷', '烟熏三文鱼贝果', '意式帕尼尼'],
      配菜小食: ['比利时薯条', '美式洋葱圈', '科尔斯劳', '美式土豆沙拉', '水牛城辣鸡翅'],
    },
    咖啡烘焙: {
      咖啡饮品: ['美式咖啡', '拿铁', '卡布奇诺', '馥芮白', '摩卡咖啡', '焦糖玛奇朵', '浓缩咖啡', '冰滴咖啡'],
      其他饮品: ['抹茶拿铁', '伯爵奶茶', '热巧克力', '柠檬气泡水'],
      烘焙点心: ['可颂', '贝果', '黄油可颂', '巧克力可颂', '肉桂卷', '葡萄干司康', '法式布里欧修', '蒜香佛卡夏'],
      甜品: ['芝士蛋糕', '巴斯克芝士蛋糕', '提拉米苏', '可丽露', '柠檬挞', '纽约芝士蛋糕'],
    },
  },
};
